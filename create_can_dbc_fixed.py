...
encoderPosEstimate = cantools.database.can.Signal("Pos_Estimate", 0, 32)
encoderPosEstimate.is_float = True
encoderVelEstimate = cantools.database.can.Signal("Vel_Estimate", 32, 32)
encoderVelEstimate.is_float = True
...
torqueFF.scale = 0.001
setInputPosMsg = cantools.database.can.Message(
    0x00C, "Set_Input_Pos", 8, [inputPos, velFF, torqueFF]
)

# 0x00D - Set Input Vel
inputVel = cantools.database.can.Signal("Input_Vel", 0, 32)
inputVel.is_float = True
inputTorqueFF = cantools.database.can.Signal("Input_Torque_FF", 32, 32)
inputTorqueFF.is_float = True
setInputVelMsg = cantools.database.can.Message(
    0x00D, "Set_Input_Vel", 8, [inputVel, inputTorqueFF]
)

# 0x00E - Set Input Torque
inputTorque = cantools.database.can.Signal("Input_Torque", 0, 32)
inputTorque.is_float = True
setInputTqMsg = cantools.database.can.Message(
    0x00E, "Set_Input_Torque", 8, [inputTorque]
)

# 0x00F - Set Velocity Limit
velLimit = cantools.database.can.Signal("Velocity_Limit", 0, 32)
velLimit.is_float = True
currentLimit = cantools.database.can.Signal("Current_Limit", 32, 32)
currentLimit.is_float = True
...
trajVelLim = cantools.database.can.Signal("Traj_Vel_Limit", 0, 32)
trajVelLim.is_float = True
setTrajVelMsg = cantools.database.can.Message(
    0x011, "Set_Traj_Vel_Limit", 8, [trajVelLim]
)

# 0x012 - Set Traj Accel Limits
trajAccelLim = cantools.database.can.Signal("Traj_Accel_Limit", 0, 32)
trajAccelLim.is_float = True
trajDecelLim = cantools.database.can.Signal("Traj_Decel_Limit", 32, 32)
trajDecelLim.is_float = True
...
trajInertia = cantools.database.can.Signal("Traj_Inertia", 0, 32)
trajInertia.is_float = True
trajInertiaMsg = cantools.database.can.Message(
    0x013, "Set_Traj_Inertia", 8, [trajInertia]
)

# 0x014 - Get Iq
iqSetpoint = cantools.database.can.Signal("Iq_Setpoint", 0, 32)
iqSetpoint.is_float = True
iqMeasured = cantools.database.can.Signal("Iq_Measured", 32, 32)
iqMeasured.is_float = True
...
sensorlessPosEstimate = cantools.database.can.Signal(
    "Sensorless_Pos_Estimate", 0, 32,
)
sensorlessPosEstimate.is_float = True
sensorlessVelEstimate = cantools.database.can.Signal(
    "Sensorless_Vel_Estimate", 32, 32,
)
sensorlessVelEstimate.isfloat = True
...
vbusVoltage = cantools.database.can.Signal("Vbus_Voltage", 0, 32)
vbusVoltage.is_float = True
...
# 0x01A - Set Pos gain
posGain = cantools.database.can.Signal("Pos_Gain", 0, 32)
posGain.is_float = True
setPosGainMsg = cantools.database.can.Message(0x01A, "Set_Pos_Gain", 8, [posGain])

# 0x01B - Set Vel Gains
velGain = cantools.database.can.Signal("Vel_Gain", 0, 32)
velGain.is_float = True
velIntGain = cantools.database.can.Signal("Vel_Integrator_Gain", 32, 32)
velIntGain.is_float = True
